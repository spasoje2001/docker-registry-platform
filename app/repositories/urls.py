...
urlpatterns = [
    ...
    path(
        "<str:name>/tags/<str:tag_name>/delete/",
        views.tag_delete_official,
        name="tag_delete_official"),

    # ===== USER REPOS  =====
    path("<str:owner_username>/<str:name>/", views.repository_detail, name="detail"),
    path("<str:owner_username>/<str:name>/edit/",
         views.repository_update, name="update"),
    path("<str:owner_username>/<str:name>/delete/",
         views.repository_delete, name="delete"),
    path("<str:owner_username>/<str:name>/tags/new/",
         views.tag_create, name="tag_create"),
    path("<str:owner_username>/<str:name>/tags/<str:tag_name>/edit/",
         views.tag_update, name="tag_update"),
    path("<str:owner_username>/<str:name>/tags/<str:tag_name>/delete/",
         views.tag_delete, name="tag_delete"),
]
